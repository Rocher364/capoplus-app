                    ...
                    <tr class="hover:bg-slate-50/80 transition duration-150">
                        ...
                        <td class="px-5 py-3.5 text-right whitespace-nowrap no-print">
                            <div class="inline-flex items-center gap-2">
                                ...
                                {{-- BOUTON RESTAURER --}}
                                <form action="{{ route('director.sauvegardes.restaurer', $b['filename']) }}" method="POST"
                                      onsubmit="return confirm('⚠️ ATTENTION : La restauration remplacera toutes les données actuelles par celles de cette sauvegarde. Voulez-vous continuer ?');">
                                    @csrf
                                    <button type="submit"
                                            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold transition shadow-sm">
